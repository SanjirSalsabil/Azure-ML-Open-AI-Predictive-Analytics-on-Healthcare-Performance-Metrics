...
Current Monthly Capacity: Total_Cases / 12 (assuming 1-year historical data)
...
# The Monthly Surgery Trend  

It shows only completed surgeries/scheduled/queued surgeries (not incorporating future cases):
...
<img width="1081" height="275" alt="Screen Shot 2025-10-20 at 2 56 25 AM" src="https://github.com/user-attachments/assets/13ff7d2f-8d69-4081-b027-a2060ae4262f" />
...
Examining the six-month forecast, we observe a consistent downward trend in the backlog. Each month shows a reduction in the total number of waiting patients, with the changes becoming progressively larger
